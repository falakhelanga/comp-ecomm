...
export const fetchProducts = (productName = "", page = "") => async (
  ...
  try {
    const { data } = await axios.get(
      `https://procomputers.herokuapp.com/api/products/?productName=${productName}&page=${page}`
    );
...
export const fetchProduct = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      `https://procomputers.herokuapp.com/api/products/${id}`
    );
...
export const fetchDiscount = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
      "https://procomputers.herokuapp.com/api/products/discount"
    );
